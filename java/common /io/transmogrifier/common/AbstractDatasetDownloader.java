...
{
    protected File[][] download(final Dataset dataset,
            ...
            IOException
    {
        ...
        if(converterURLString != null)
        {
            ...
            {
                handler.converterDownloadFailed(dataset,
                                                ex);
        ...
        for(final Download download : downloads)
        {
            ...
            handler.datasetDownloadStarted(dataset,
                                           download);
            ...
            IOException
    {
        ...
        try
        {
            ...
            downloadFile = File.createTempFile("tmg",
                                               null);
